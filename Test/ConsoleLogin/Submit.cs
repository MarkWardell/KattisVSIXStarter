...
{
    public class KattisSubmitter
    {
        List<RestResponseCookie> cookies = null;
        public KattisSubmitter(Dictionary<string, string> configDict)
        {

        }

        public bool Login(string username = null, string pwd = null)
        {
            return true;
        }

        public bool Submit(string[] files, string problem, string language = null)
        {
            return true;
        }
    ...
    {
        public static Dictionary<string, string> LANG_GUESS = new Dictionary<string, string>()
        {
        ...
        {
            {"User-Agent" , "csharp-cli-submit"}
        };

        public string Url { get { return @"https:\\open.kattis.com"; } }

        public string LoginUrl { get { return $@"{Url}\login"; } }


        public string SubmitnUrl
        {
            get { return $@"{Url}\Submit"; }
...
def get_config():
    ...
    if not cfg.read([os.path.join(os.getenv('HOMEPATH'), '.kattisrc'),
